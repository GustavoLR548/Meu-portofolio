...
\begin{document}
    ...
    \begin{question}
        \begin{enumerate}[label={\textbf{\alph*)}}]
            \item        
            \begin{equation}
                (\frac{6!}{0!(6-0)!} * 0.3^{0}*(1-0.3)^{6})*100 = 11.7649\%
            \end{equation}
            \item 
            \[
    ...
    \end{question}
     ...
     \begin{question}
        \begin{enumerate}[label={\textbf{\alph*)}}]
            ...
            \item 
            \begin{equation}
                \frac{5}{13} * \frac{4}{12} * \frac{3}{11} = \frac{60}{1716} \rightarrow 0.0349
            \end{equation}
        \end{enumerate}
    \end{question}
