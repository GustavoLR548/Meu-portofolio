...
\end{itemize}
\smallskip
\cvproject{\hyperlink{https://github.com/GustavoLR548/LDDM-PUC2021}{Laboratório de Desenvolvimento para Dispositivos Móveis}}
\begin{itemize}
\item Durante minha disciplina de LDDM, fiz vários aplicativos usando Flutter/Dart e guardei todos os projetos no Github
\end{itemize}
\smallskip
\cvproject{\hyperlink{https://github.com/GustavoLR548/EclipseJogos}{Criação de Jogos em Java usando a IDE Eclipse}}
\begin{itemize}
